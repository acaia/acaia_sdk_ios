...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onFailed:) name:AcaiaScaleConnectFailed object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onDisconnect:) name:AcaiaScaleDidDisconnected object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onWeight:) name:AcaiaScaleWeight object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onTimer:) name:AcaiaScaleTimer object:nil];
}
...
- (void)onWeight:(NSNotification *)noti {
    AcaiaScaleWeightUnit unit = [[[noti userInfo] objectForKey:AcaiaScaleUserInfoKeyUnit] unsignedIntegerValue];
    float weight = [[[noti userInfo] objectForKey:AcaiaScaleUserInfoKeyWeight] floatValue];
